	...
	<script language="javascript">
		...
		function yiyuanAll()
		{
			if(i==0)
			{
				...
				loginService.yiyuanAll(callback);
			}
		...
		function keshiAll()
		{
			if(document.form1.yiyuanid.value==0)
			{
				alert("请前选择医院");
			}
			else
		...
		function aa()
		{
			DWRUtil.removeAllOptions("keshiid");
			j=0;
		}
...
<form action="<%=path %>/userAddSL.action" name="form1" method="post">
	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
				&nbsp;
				<select name="yiyuanid" id="yiyuanid" onclick="yiyuanAll()" style="width: 155px;" onchange="aa()">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
				&nbsp;
				<select name="keshiid" id="keshiid" onclick="keshiAll()" style="width: 155px;">
