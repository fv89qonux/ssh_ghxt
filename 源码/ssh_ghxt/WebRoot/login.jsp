  ...
  <head>
    ...
    <script language="javascript">
		function check1()
		{
			...
			loginService.login(document.getElementById("loginname").value,document.getElementById("loginpw").value,0,callback);
		}
	    ...
	    <form action="<%=path %>/admin/index.jsp" method="post" id="ThisForm" name="login-form">
		    <div class="login-info">
				<span class="user">&nbsp;</span>
				    <input name="loginname" id="loginname" type="text" class="login-input"/>
				</div>
		    <div class="login-info">
				<span class="pwd">&nbsp;</span>
				<input name="loginpw" id="loginpw" type="password" class="login-input"/>
			</div>
			<%--<div class="login-info">
				<span class="pwd">&nbsp;</span>
